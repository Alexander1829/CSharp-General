...
//Начну с "D", так как это самый используемый принцип в реальных проектах. А дальше по порядку.
namespace SOLID_in_CSharp
{
    ...
    /*Другая метачущность: строитель отчётов ( по сотрудникам )*/
    ...
    перегружать интерфейсы. Стацианарно: один интерфейс - один метод.
